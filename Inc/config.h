...
#define BAT_CALIB_REAL_VOLTAGE  3895      // input voltage measured by multimeter (multiplied by 100). In this case 43.00 V * 100 = 4300
#define BAT_CALIB_ADC           1565      // adc-value measured by mainboard (value nr 5 on UART debug output)
...
// ############################ VARIANT_USART SETTINGS ############################
  ...
  #define PRI_INPUT2             3, -1000, 0, 1000, 0     // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
    ...
    #define SPEED_PID_P 80U //cf_nKp 4833U
    #define SPEED_PID_I 50U //cf_nKi 251U
